                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Align(
                            ...
                            child: Text(
                                widget.cupom.estabelecimento.nome.toString(),
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                                """${widget.cupom.estabelecimento.rua.toString()}, ${widget.cupom.estabelecimento.numero.toString()}, ${widget.cupom.estabelecimento.bairro}""",
                                style: GoogleFonts.montserratAlternates(
                                    fontSize: 16,
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          child: InkWell(
                        onTap: () async {
                          await utils.openPhone(
                              widget.cupom.estabelecimento.telefone.toString());
                        },
                        child: Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                                '${widget.cupom.estabelecimento.telefone}',
                                style: GoogleFonts.montserratAlternates(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w500,
                                    color: Colors.black))),
                  ...
                  Padding(
                      ...
                      child: Align(
                          ...
                          child: Text(
                              'De R\$ ${widget.cupom.preco.toStringAsFixed(2)} por R\$ ' +
                                  (widget.cupom.preco * (1 - (widget.cupom.porc_desconto / 100)))
                                  .toStringAsFixed(2) + '\ncom ${widget.cupom.porc_desconto.toStringAsFixed(0)}% de desconto',
                              style: GoogleFonts.comfortaa(
                                  fontSize: 15,
                                  fontWeight: FontWeight.w900,
                  ...
                  Align(
                      alignment: Alignment.center,
                      child: Text('   Conclua as tarefas \npara validar o cupom:',
                          style: GoogleFonts.montserratAlternates(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Colors.black))),
                  ...
                  resgatado ? Text('Este cupom já foi resgatado!') : ElevatedButton(
                          child: Text(
                            'Resgatar Cupom',
                            style: GoogleFonts.montserratAlternates(
                          ...
                          onPressed: () async {
                            await cupomDialog.pegarCupom(
                                widget.cupom,
                                widget.usuario.getId.toString(),
                                resgatadoState,
                                context);
                          },
